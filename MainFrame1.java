...
public class MainFrame1 extends JFrame {
    ...
    private void addRadioButton(String name, final int formula_number)           // радиокнопки для формул
    {
        ...
        button.addActionListener(new ActionListener()
        {
            ...
            {
                MainFrame1.this.formula_number = formula_number;
                if (formula_number == 1)	image.setIcon(new ImageIcon(MainFrame3.class.getResource("formula_1.jpg")));
                if (formula_number == 2) image.setIcon(new ImageIcon(MainFrame3.class.getResource("formula_2.jpg")));
            }
        });
    ...
    public MainFrame1() {
        ...
        image = new JLabel(new ImageIcon(MainFrame1.class.getResource("formula_1.jpg")));
        picture.add(image);
        picture.add(Box.createHorizontalGlue());
